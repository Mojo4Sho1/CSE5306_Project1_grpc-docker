...
type EchoReply struct {
	...
	Echoed        string                 `protobuf:"bytes,2,opt,name=echoed,proto3" json:"echoed,omitempty"`
...
func (x *EchoReply) GetOriginal() string {
	if x != nil {
		return x.Original
	}
	return ""
...
func (x *EchoReply) GetEchoed() string {
	if x != nil {
		return x.Echoed
	}
	return ""
...
func (x *EchoReply) GetLength() int32 {
	if x != nil {
		return x.Length
	}
	return 0
...
const file_echo_proto_rawDesc = "" +
	...
	"\x06echoed\x18\x02 \x01(\tR\x06echoed\x12\x16\n" +
	"\x06length\x18\x03 \x01(\x05R\x06length29\n" +
	"\vEchoService\x12*\n" +
	"\x04Echo\x12\x11.echo.EchoRequest\x1a\x0f.echo.EchoReplyB<Z:github.com/Mojo4Sho1/CSE5306_Project1_grpc-docker/go/pb;pbb\x06proto3"
...
var file_echo_proto_depIdxs = []int32{
	...
	1, // 1: echo.EchoService.Echo:output_type -> echo.EchoReply
